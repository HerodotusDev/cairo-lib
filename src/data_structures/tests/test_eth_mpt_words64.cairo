...
fn test_decode_rlp_node_branch() {
    ...
    let expected_node = MPTWords64Node::Branch((expected.span(), expected_value.span()));
...
fn test_decode_rlp_node_leaf_odd() {
    ...
    let decoded = MPTWords64Trait::decode_rlp_node(rlp_node.span()).unwrap();
    let expected_node = MPTWords64Node::Leaf((expected_key_end.span(), expected_value.span(), 1));
...
fn test_hash_rlp_node() {
    ...
    let hash = MPTWords64Trait::hash_rlp_node(rlp_node.span());
    assert(
